...
@section('panel-header')
    <div>
        <h1 class="panel-title">Edit Branch</h1>
        <ul class="breadcrumb">
            <li><a href="{{ route('admin.view.dashboard') }}">Admin</a></li>
            <li><i data-feather="chevron-right"></i></li>
            <li><a href="{{ route('admin.view.branch.list') }}">Branches</a></li>
            <li><i data-feather="chevron-right"></i></li>
            <li><a href="{{ route('admin.view.branch.update', ['id' => $branch->id]) }}">Edit Branch</a></li>
        </ul>
    </div>
@endsection

@section('panel-body')
    <form action="{{ route('admin.handle.branch.update', ['id' => $branch->id]) }}" method="POST" enctype="multipart/form-data">
        @csrf
