                            ...
                            <tr>
                                ...
                                <td>
                                    <label class="relative cursor-pointer">
                                        <input onchange="handleUpdateStatus({{$admin->id}})" @checked($admin->status) type="checkbox" class="sr-only peer">
                                ...
                                <td>
                                    <div class="table-dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <ul>
                                                <li><a href="{{route('admin.view.admin.update',['id' => $admin->id])}}" class="dropdown-link-primary"><i data-feather="edit" class="mr-1"></i> Edit Admin Access</a></li>
