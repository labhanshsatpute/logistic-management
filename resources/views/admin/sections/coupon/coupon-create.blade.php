...
@section('panel-header')
    <div>
        <h1 class="panel-title">Create a Coupon</h1>
        <ul class="breadcrumb">
            <li><a href="{{ route('admin.view.dashboard') }}">Admin</a></li>
            <li><i data-feather="chevron-right"></i></li>
            <li><a href="{{ route('admin.view.coupon.list') }}">Coupons</a></li>
            <li><i data-feather="chevron-right"></i></li>
            <li><a href="{{ route('admin.view.coupon.create') }}">Create a Coupon</a></li>
        </ul>
    </div>
@endsection

@section('panel-body')
    <form action="{{route('admin.handle.coupon.create')}}" method="POST" enctype="multipart/form-data">
        @csrf
        <figure class="panel-card">
            ...
            <div class="panel-card-body">
                <div class="grid md:grid-cols-4 sm:grid-cols-1 md:gap-7 sm:gap-5">
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="space-x-3 flex">
                            <div class="input-radio">
                                <input type="radio" value="Fixed" @checked(old('discount_type') == 'Fixed') name="discount_type"
                                    id="discount_type_fixed" required>
                                <label for="discount_type_fixed">Fixed</label>
                            </div>
                            <div class="input-radio">
                                <input type="radio" value="Percentage" @checked(old('discount_type') == 'Percentage') name="discount_type"
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="space-x-3 flex">
                            <div class="input-radio">
                                <input type="radio" value="New User" @checked(old('user_type') == 'New User') name="user_type"
                                    id="user_type_new" required>
                                <label for="user_type_new">New User</label>
                            </div>
                            <div class="input-radio">
                                <input type="radio" value="All User" @checked(old('user_type') == 'All User') name="user_type"
                    ...
                    <div class="flex flex-col">
                        ...
                        <input type="number" step="any" name="discount_value" value="{{ old('discount_value') }}"
                    ...
                    <div class="flex flex-col">
                        ...
                        <input type="number" step="any" name="minimum_purchase" value="{{ old('minimum_purchase') }}"
            ...
            <div class="panel-card-footer">
                <button type="submit" class="btn-primary-md md:w-fit sm:w-full">Create Coupon</button>
            </div>
        </figure>
    </form>
@endsection
