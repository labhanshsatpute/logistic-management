...
@section('panel-header')
    <div>
        <h1 class="panel-title">Edit Parent Category</h1>
        <ul class="breadcrumb">
            <li><a href="{{ route('admin.view.dashboard') }}">Admin</a></li>
            <li><i data-feather="chevron-right"></i></li>
            <li><a href="{{ route('admin.view.parent.category.list') }}">Parent Categories</a></li>
            <li><i data-feather="chevron-right"></i></li>
            <li><a href="{{ route('admin.view.parent.category.update', ['id' => $parent_category->id]) }}">Edit</a></li>
        </ul>
    </div>
@endsection

@section('panel-body')
    <form action="{{ route('admin.handle.parent.category.update', ['id' => $parent_category->id]) }}" method="POST"
            ...
            <div class="panel-card-body">
                <div class="grid md:grid-cols-4 sm:grid-cols-1 md:gap-7 sm:gap-5">
                    ...
                    <div class="flex flex-col md:col-span-2 sm:col-span-1">
                        ...
                        <input type="text" name="name" value="{{ old('name', $parent_category->name) }}"
                    ...
                    <div class="flex flex-col md:col-span-2 sm:col-span-1">
                        ...
                        <input type="text" name="slug" value="{{ old('slug', $parent_category->slug) }}"
                    ...
                    <div class="flex flex-col md:col-span-4 sm:col-span-1">
                        ...
                        <input type="text" name="summary" value="{{ old('summary', $parent_category->summary) }}"
                    ...
                    <div class="flex flex-col md:col-span-4 sm:col-span-1">
                        ...
                        <textarea name="description" rows="5" class="input-box-md @error('description') input-invalid @enderror"
                            placeholder="Enter description">{{ old('description', $parent_category->description) }}</textarea>
                        @error('description')
                            <span class="input-error">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="md:col-span-4 sm:col-span-1">
                        ...
                        <div class="flex space-x-3 my-2">
                            ...
                            <img src="{{ is_null($parent_category->thumbnail) ? asset('admin/images/default-thumbnail.png') : asset('storage/' . $parent_category->thumbnail) }}"
                    ...
                    <div class="md:col-span-4 sm:col-span-1">
                        ...
                        <div class="flex space-x-3 my-2">
                            ...
                            <img src="{{ is_null($parent_category->cover_image) ? asset('admin/images/default-thumbnail.png') : asset('storage/' . $parent_category->cover_image) }}"
        ...
        const handleThumbnailPreview = (event) => {
            if (event.target.files.length == 0) {
                document.getElementById('thumbnail').src =
                    "{{ is_null($parent_category->thumbnail) ? asset('admin/images/default-thumbnail.png') : asset('storage/' . $parent_category->thumbnail) }}";
            } else {
        ...
        const handleCoverImagePreview = (event) => {
            if (event.target.files.length == 0) {
                document.getElementById('cover_image').src =
                    "{{ is_null($parent_category->cover_image) ? asset('admin/images/default-thumbnail.png') : asset('storage/' . $parent_category->cover_image) }}";
            } else {
        ...
        const handleDelete = () => {
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        window.location =
                            "{{ route('admin.handle.parent.category.delete', ['id' => $parent_category->id]) }}";
                    }
                });
        }
    </script>
